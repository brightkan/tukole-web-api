...
class Fleet(TimeStampedModel):
    ...
    state_choices = (('picked_up', 'picked_up'), ('returned', 'returned'), ('removed', 'removed'))
...
class UserFleetAssignment(TimeStampedModel):
    approve_status = ((0, 0), (1, 1), (2, 2), (3, 3), (4, 4))
    assignment_type_choices = (('assignment', 'Assignment'), ('request', 'Request'))

    type_choices = (('machine', 'Machine'), ('fleet', 'Fleet'))
    assignment_type = models.CharField(
        max_length=150, null=True, blank=True, choices=assignment_type_choices
    )
    ...
    approved_by = models.ForeignKey(
        to=User, on_delete=models.CASCADE, related_name="user_fleet_approver", null=True, blank=True
    )
